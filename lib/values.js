...
module.exports = {
	...
	serializeFunctionOrClass(fn, superClass) {
		...
		return this.serializeClass(fn, superClass);
	},
	...
	serializeClass(klass) { // eslint-disable-line no-unused-vars
		// TODO
		throw new Error('Serializing classes not implemented');
	},
	...
	wrapWithProps(obj, js, dependencies, shouldSkipKey) {
		...
		dependencies.push(...propsDependencies, Object.assign);
